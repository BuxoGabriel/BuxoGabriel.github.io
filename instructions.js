...
let instructions =  {
    draw() {
        ...
        text("Welcome to our fighting game! The goal of this game is to inflict damage upon your opponenent's health within the time limit provided!", width*0.5, height*0.2);
        textSize(18);
        textStyle(BOLD);
